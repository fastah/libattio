...
type V2TasksTaskIdPatchRequestDataLinkedRecordsInner struct {
	...
	V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1 *V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1
}
...
func (dst *V2TasksTaskIdPatchRequestDataLinkedRecordsInner) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal JSON data into V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1
	err = json.Unmarshal(data, &dst.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1);
	if err == nil {
		jsonV2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1, _ := json.Marshal(dst.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1)
		if string(jsonV2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1) == "{}" { // empty struct
			dst.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1 = nil
		} else {
			return nil // data stored in dst.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1, return on the first match
		}
	} else {
		dst.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1 = nil
	}
...
func (src V2TasksTaskIdPatchRequestDataLinkedRecordsInner) MarshalJSON() ([]byte, error) {
	...
	if src.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1 != nil {
		return json.Marshal(&src.V2TasksTaskIdPatchRequestDataLinkedRecordsInnerAnyOf1)
	}
